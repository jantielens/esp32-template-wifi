...
- Touch: GT911 I2C (SDA=19, SCL=45) — not yet enabled
...
- Enables display, disables touch (phase 2).
...
Support + docs:
- src/app/app.ino (watchdog settings for long display init)
